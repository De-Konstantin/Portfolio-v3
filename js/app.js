(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".skill__slider", {
    ...
    const observer = new IntersectionObserver((entries => {
        ...
        entries.forEach((entry => {
            if (entry.isIntersecting) document.querySelectorAll(".menu__link ").forEach((link => {
                ...
                if (id === entry.target.classList.value) link.classList.add("menu__link-active"); else link.classList.remove("menu__link-active");
            }));
        }));
    }), {
        threshold: .7
    ...
    function trail() {
        ...
        class Particle {
            constructor() {
                ...
                this.speedX = 3;
                this.speedY = 3;
                this.color = "hsla(" + hue + ", 80%, 50%, 0.15)";
            }
            update() {
                this.x += this.speedX;
                this.y += this.speedY;
                if (this.size > .3) this.size -= .015;
            }
            draw() {
        ...
        function handleParticle() {
            for (let i = 0; i < spots.length; i++) {
                ...
                for (let j = i; j < spots.length; j++) {
                    ...
                    const dy = spots[i].y - spots[j].y + 1;
        ...
        particles: {
            ...
            shape: {
                character: {
                    ...
                    font: "BioRhyme",
                    style: "",
                    value: [ "Javascript", "</p>", "css", "<body>", "php", "VueJS", "Gulp", "VS Code", "<HTML>", "<div>", "<footer>", "Git", "const", "<br>", "webpack", "function" ],
                    weight: "400"
                },
                polygon: {
                    nb_sides: 5
    ...
    video.forEach;
    document.addEventListener("afterPopupClose", (function() {
        video.forEach((e => {
            e.pause();
        }));
    }));
